...
exports.createUser = functions.runWith({runtime: 'nodejs18'})
...
exports.updateUserRole = functions.runWith({runtime: 'nodejs18'})
    .https.onCall(async (data, context) => {
      await assertAdmin(context);
      const {uid, role} = data;
...
exports.deleteUser = functions.runWith({runtime: 'nodejs18'})
    .https.onCall(async (data, context) => {
      await assertAdmin(context);
      const {uid} = data;
