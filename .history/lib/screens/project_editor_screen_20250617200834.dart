      ...
      children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final thumb = path.startsWith('http')
                          ? Image.network(path, width: 48, height: 48, fit: BoxFit.contain)
                          : Image.file(File(path), width: 48, height: 48, fit: BoxFit.contain);
                      return Padding(
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Container(
                // subtle border around the text area as well
                ...
                child: GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontStyle: _notes.isEmpty ? FontStyle.italic : FontStyle.normal,
                    ),
                  ),
                ),
              ),
