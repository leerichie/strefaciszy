                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return ListTile(
                      ...
                      title: RichText(
                        text: TextSpan(
                          style: DefaultTextStyle.of(
                            context,
                          ).style, // keep default font/size
                          children: [
                            TextSpan(
                              // coloured initials only
                              text: d['type'],
                              style: TextStyle(
                                color: _typeColor(d['type'] as String),
                              ),
                            ),
                            const TextSpan(text: ' — '), // plain separator
                            TextSpan(
                              text: d['projectName'] ?? '',
                            ), // plain project name
                          ],
                      ...
                      // … the rest of your ListTile stays exactly as you have it …
                      subtitle: Column(
