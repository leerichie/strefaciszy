                              ...
                              onPressed: () async {
                                ...
                                if (_lines.isEmpty) {
                                  ...
                                  if (snap.docs.isNotEmpty) {
                                    ...
                                    // 2) batch: restore stock for each line then delete the doc
                                    ...
                                    // 3) UI feedback and reset
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Przywrócono stan i usunięto pusty dokument RW',
                                        ),
                                      ),
                                    );
                                    ...
                                    setState(() {
                                      _lines =
                                          []; // everything is gone, and previousQty no longer matters
                                    });
                                  }
                                }
                              },
