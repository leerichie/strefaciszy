...
class _CustomerDetailScreenState extends State<CustomerDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ↓↓↓ Replace your bottomNavigationBar & remove persistentFooterButtons ↓↓↓
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          child: Row(
            // space icons out evenly over the width
            ...
            children: [
              ...
              // Scan (we leave a gap under the FAB)
              SizedBox(width: 48), // half-notch width
