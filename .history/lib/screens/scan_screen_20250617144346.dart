...
class ScanScreen extends StatefulWidget {
  /// If true, scan results will be returned to the caller via Navigator.pop(code).
  /// If false (the default), a successful scan will navigate to the detail screen.
        ...
        .then((snap) {
          if (snap.docs.isNotEmpty) {
            if (widget.returnCode) {
              // Return the raw code to the caller
