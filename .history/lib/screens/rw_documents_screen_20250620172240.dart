                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    // 1) Return stock for each item in the document
                                    final items =
                                    ...
                                    for (final item in items) {
                                      ...
                                      batch.update(stockRef, {
                                        ...
                                        'updatedBy': /* your current user ID, e.g. */
                                            FirebaseAuth
                                                .instance
                                                .currentUser!
                                                .uid,
                                    ...
                                    // 2) Delete the RW doc itself
                                    final docRef = doc.reference;
                                    batch.delete(docRef);

                                    // 3) Commit both updates atomically
                                    await batch.commit();

                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Dokument i stan magazynu zaktualizowane',
                                        ),
                                      ),
                                    );
                                  },
