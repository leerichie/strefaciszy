...
class AuditLogScreen extends StatelessWidget {
  ...
  /// Render one log entry, with details in the exact order:
  /// Klient → Projekt → Szczegóły → (others)
  Widget _buildActionRow(BuildContext c, Map<String, dynamic> data) {
    ...
    // Build lines in the exact order requested:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Historia – RW wg użytkownika')),
        ...
        builder: (ctxU, userSnap) {
          ...
          return StreamBuilder<QuerySnapshot>(
            ...
            builder: (ctxL, logSnap) {
              ...
              // Group by userId (fallback to email if missing)
