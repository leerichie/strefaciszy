...
class _RWDocumentsScreenState extends State<RWDocumentsScreen> {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    // start the async lookup if needed
  ...
  Future<void> _fetchUserName(String uid) async {
    ...
    try {
      final snap = await FirebaseFirestore.instance
          ...
          .get();
      final d = snap.data();
      final name = (d?['name'] ?? d?['email']) as String? ?? uid;
      ...
      setState(() {
        userNames[uid] = uid; // fallback to UID
      });
    }
  }
  ...
  Future<void> _exportToExcel(
    ...
    // 5) List each item starting at rowIndex = 4
    var row = 4;
