...
class _RWDocumentsScreenState extends State<RWDocumentsScreen> {
  ...
  Future<void> _exportToExcel(
    ...
    bool shareAfterExport = false, // Not used, safe to leave
  }) async {
    final excel = Excel.createExcel();
    final sheet = excel['Dokument'];

    // Set column widths
    sheet.setColWidth(0, 20); // Typ
    sheet.setColWidth(1, 25); // Klient
    sheet.setColWidth(2, 35); // Projekt
    sheet.setColWidth(3, 20); // Utworzono
    sheet.setColWidth(4, 25); // Użytkownik
    ...
    // Material headers with custom widths
    sheet.setColWidth(0, 35); // Nazwa materiału
    sheet.setColWidth(1, 12); // Ilość
