...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
  ...
  return Dialog(
          ...
          child: SizedBox(
            width: MediaQuery.of(ctx).size.width * 0.9,   // <— fixed 90% width
            child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<bool>(
                              value: isStock,
                              decoration:
                                  const InputDecoration(labelText: 'Produkt'),
                              items: const [
                                DropdownMenuItem(
                                    value: true, child: Text('W Magazynie')),
                                DropdownMenuItem(
                                    value: false, child: Text('Custom')),
                              ],
                              onChanged: (v) =>
                                  setState(() => isStock = v!),
                            ),
