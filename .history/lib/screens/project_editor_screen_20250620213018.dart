                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: Icon(Icons.delete, color: Colors.red),
                              onPressed: () async {
                                // 1) Remove from in-memory preview
                                setState(() => _lines.removeAt(i));

                                // 2) If that was the last line, undo the saved RW and clear project
                                if (_lines.isEmpty) {
                                  final projectRef = FirebaseFirestore.instance
                                      .collection('customers')
                                      .doc(widget.customerId)
                                  ...
                                  if (snap.docs.isNotEmpty) {
                                    ...
                                    // Batch: 1) restore stock for each item, 2) delete the RW doc, 3) clear the project
