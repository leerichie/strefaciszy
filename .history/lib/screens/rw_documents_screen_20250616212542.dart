...
class _RWDocumentsScreenState extends State<RWDocumentsScreen> {
  ...
  Future<void> _exportToExcel(
    ...
    final bytes = excel.encode()!; // your XLSX bytes
    ...
    if (savedPath != null) {
      ...
      // on web or iOS share-sheet case, you can show a generic message
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Plik został pobrany/udostępniony.')),
      );
    }
  }
}
