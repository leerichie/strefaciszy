      ...
      floatingActionButton: _rwLocked
          ...
          : FloatingActionButton(
              ...
              onPressed: () async {
                ...
                // 2) Apply your unit‐lookup for stock items
                ...
                // 3) Find an existing index (if any)
                ...
                // 4a) If it already exists, re-open the dialog prefilled
                if (existingIndex != -1) {
