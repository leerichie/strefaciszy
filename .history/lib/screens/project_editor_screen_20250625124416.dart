                  ...
                  PhotoGallery(
                    ...
                    onAddImage: (source) async {
                      ...
                      if (source == ImageSource.camera) {
                        // stock‐style camera upload
                        url = await _storage.pickAndUpload(widget.projectId);
                      } else {
                        // gallery upload into project_images
                        url = await _storage.pickAndUploadProjectImage(
                          widget.projectId,
                        );
                      }
                      if (url != null) {
                    ...
                    onDelete: (i) async {
                      ...
                      // no local setState if using Firestore listener
                    },
                  ),
