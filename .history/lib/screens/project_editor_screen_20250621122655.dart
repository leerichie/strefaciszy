...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final isLocked = isSynced && !isToday && !widget.isAdmin;
  ...
  IconButton(
    ...
    onPressed: () {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Tylko administrator może edytować starsze pozycje')),
      );
    },
  ),
...
if (!isLocked)
  ...
  IconButton(
    ...
    onPressed: () {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Tylko administrator może usuwać starsze pozycje')),
      );
    },
  ),
