    ...
    return showDialog<ProjectLine>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setState) {
          // 1) Recompute the filtered list on each rebuild
          ...
          // 2) Wrap in MediaQuery.removeViewInsets to keep dialog size constant
          return MediaQuery.removeViewInsets(
            context: ctx,
            removeBottom: true,
            child: AlertDialog(
              // 3) Force a consistent width via insetPadding
              insetPadding: const EdgeInsets.symmetric(horizontal: 24),
              title: Text(existing == null ? 'Dodaj' : 'Edytuj'),
              contentPadding: EdgeInsets.zero,
              content: ConstrainedBox(
                // 4) Cap total dialog height to 60% of screen
                constraints: BoxConstraints(
                  maxHeight: MediaQuery.of(ctx).size.height * 0.6,
                ),
                child: SingleChildScrollView(
                  // 5) Inner scroll view for form + suggestions
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // 7a) STOCK ITEM search field + scanner
                        if (isStock) ...[
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                ...
                                onPressed: () async {
                                  // your existing ScanScreen logic here...
                          ...
                          // 7b) Live suggestions in a simple scrollable column
                          if (filtered.isNotEmpty && itemRef.isEmpty) ...[
