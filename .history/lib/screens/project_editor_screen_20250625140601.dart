                ...
                children: [
                  ...
                  PhotoGallery(
                    ...
                    onAddImage: (source) async {
                      ...
                      setState(
                        () => _localPreviews.add(picked.path),
                      ); // ← ADDED
                    ...
                    onDelete: (i) async {
  final urlOrPath = i < _imageUrls.length
      ? _imageUrls[i]
      : _localPreviews[i - _imageUrls.length];       // ← ADDED if you mix them
  // (your existing Firestore removal goes here if it's a URL)
  setState(() {
    if (i < _imageUrls.length)
      _imageUrls.removeAt(i);
    else
      _localPreviews.removeAt(i - _imageUrls.length);
  });
},
