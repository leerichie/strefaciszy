...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
  ...
  Future<void> _saveRWDocument(String type) async {
    ...
    final todaySnap = await rwCol
        .where('type', isEqualTo: type)
        .where('createdAt', isGreaterThanOrEqualTo: startOfDay) // ← NEW
        .where('createdAt', isLessThan: startOfTomorrow) // ← NEW
        .orderBy('createdAt', descending: true) // ← NEW
        .limit(1)
        .get();
