            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (_, snap) {
                ...
                final filtered = docs.where((doc) {
                  ...
                  final project = (d['projectName'] ?? '')
                      .toString()
                      .toLowerCase();
                  final txtOk =
                      _userFilter.isEmpty ||
                      uName.contains(_userFilter.toLowerCase()) ||
                      project.contains(_userFilter.toLowerCase());
                  final typeOk =
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final typeColor = type == 'MM'
                        ? Colors.blue
                        : type == 'RW'
                        ? Colors.green
                        : null; // anything else = default
                    ...
                    final titleWidget = RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: type,
                            style: typeColor == null
                                ? null
                                : TextStyle(color: typeColor),
                          ),
                          TextSpan(text: ' — ${d['projectName'] ?? ''}'),
                        ],
                      ),
                    );
