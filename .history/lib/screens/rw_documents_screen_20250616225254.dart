...
class _RWDocumentsScreenState extends State<RWDocumentsScreen> {
  ...
  Future<void> _exportToExcel(
    ...
    for (var col = 0; col < 6; col++) {
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: col, rowIndex: infoRow))
    ...
    final hdrRow = 4;
    sheet
            .cell(CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: hdrRow))
            .cellStyle =
        headerStyle;
    sheet
            .cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: hdrRow))
            .cellStyle =
        headerStyle;
    ...
    final safeProject = project.replaceAll(RegExp(r'\s+'), '_');
