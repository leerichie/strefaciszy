              ...
              return ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    ...
                    // 2) small gap and delete (if admin)
                    if (widget.isAdmin) ...[
      const SizedBox(width: 8),
      IconButton(
        ...
        onPressed: () async {
          final shouldDelete = await showDialog<bool>(
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: Text(
                'Na pewno usunąć klienta "${d['name']}" i wszystkie jego projekty?',
              ),
              actions: [
                TextButton(
          ...
          if (shouldDelete == true) {
            // optionally delete subcollections first if you need to clean up
            await _col.doc(snap.id).delete();
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Klient "${d['name']}" usunięty')),
            );
          },
                    ],
                  ],
