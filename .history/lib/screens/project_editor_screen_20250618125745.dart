...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
  ...
  void didChangeDependencies() {
    ...
    // 3) Reload project data whenever this widget is re-inserted:
    _loadAll();
  }
      ...
      await db.runTransaction((tx) async {
        for (final ln in _lines.where((l) => l.isStock)) {
          ...
          if (delta > 0 && delta > currentQty) {
            throw Exception('Za mało ${stockSnap.data()!['name']}');
          }

          final newStock = currentQty - delta;
          tx.update(stockRef, {
            'quantity': newStock,
                            ...
                            onPressed: () {
                              ...
                              Navigator.of(ctx).pop(
                                ProjectLine(
                                  ...
                                  requestedQty: qty,
                                  unit: unit,
                                  originalStock: selectedStockItem.quantity,
                                  previousQty:
