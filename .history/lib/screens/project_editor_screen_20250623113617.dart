...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Center-docked FAB for “Dodaj pozycję”
      ...
      // bottomSheet: the Update/Zapisz RW button, above the navbar
      bottomSheet: _rwLocked
          ? null
          : SafeArea(
              child: Padding(
      ...
      // 1) Center-docked FAB for “Dodaj pozycję”
      floatingActionButton: _rwLocked
          ? null
          : FloatingActionButton(
              tooltip: 'Dodaj pozycję',
      ...
      // 2) Single bottomNavigationBar with both save button and notch bar
      bottomNavigationBar: SafeArea(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // A) “Zapisz RW” button row, above the bar
            if (!_rwLocked)
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 8, 16, 0),
                child: Row(
            ...
            // B) The actual BottomAppBar with notch and two icons
            BottomAppBar(
              elevation: 0,
