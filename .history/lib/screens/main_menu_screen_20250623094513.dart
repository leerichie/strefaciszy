...
class MainMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Your existing menu content stays in the body:
      body: ListView(
        ...
        children: [
          ...
          // We’ll keep “Historia RW” and “Download” here, but
          // remove the standalone “Inwentaryzacja”, “Klienci” and “Scan” tiles
          // so they live in the bottom bar instead.
          if (isAdmin) ...[
            const Divider(),
            ListTile(
      ...
      // 1. FloatingActionButton for Scan in the middle:
      ...
      // 2. BottomAppBar with Inventory & Clients shortcuts:
