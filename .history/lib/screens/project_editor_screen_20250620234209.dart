...
class _ProjectEditorScreenState extends State<ProjectEditorScreen> {
  ...
  Future<void> _saveRWDocument(String type) async {
   ...
   } catch (dynamic exception, StackTrace stack) {
  // If it's a FirebaseException, print its message and code:
  if (exception is FirebaseException) {
    debugPrint('Firestore failed (${exception.code}): ${exception.message}');
  } else {
