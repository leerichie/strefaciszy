                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      // 🟢 use live stockItem.quantity, not ln.originalStock
                      final stockItem = _stockItems.firstWhere(
                        (s) => s.id == ln.itemRef,
                      );
                      final remaining = stockItem.quantity - ln.requestedQty;
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                // 1) If this was a stock item, give its qty back to inventory immediately
                                if (removed.isStock) {
                                ...
                                // 2) Now remove it from the UI list
