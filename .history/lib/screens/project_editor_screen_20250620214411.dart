                      ...
                      return ListTile(
                        title: Row(
                          children: [
                            ...
                            if (ln.requestedQty == ln.previousQty)
                              Container(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              icon: Icon(Icons.delete, color: Colors.red),
                              onPressed: () async {
                                // 1) Remove from in-memory preview immediately
                                setState(() => _lines.removeAt(i));

                                // 2) If that was the last line, batch-restore & clear
                                if (_lines.isEmpty) {
                                  final projectRef = FirebaseFirestore.instance
                                      .collection('customers')
                                      .doc(widget.customerId)
                                  ...
                                  // Use createdDay for the lookup instead of createdAt ranges
                                  final now = DateTime.now();
                                  ...
                                  if (snap.docs.isNotEmpty) {
                                    ...
                                    // 3) In one batch: restore stock, delete RW doc, clear project
