  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // 2️⃣  Replace the PreferredSize in the AppBar with ↓
        ...
        children: [
          ...
          : null,
            child: StreamBuilder<QuerySnapshot>(
              stream:
                  _projectsCol.orderBy('createdAt', descending: true).snapshots(),
              builder: (ctx, snap) {
              ...
              final lines = <String>[
                ...
                if (end.isNotEmpty) 'Koniec: $end',
                if (costStr.isNotEmpty) 'Koszt: $costStr',
                if (created.isNotEmpty) 'Utworzony: $created',
              ];
                        ...
                        onPressed: () async {
                          final ok = await showDialog<bool>(
                            ...
                            builder: (ctx) => AlertDialog(
                              ...
                              content: Text('Na pewno usunąć projekt?'),
                              actions: [
                                TextButton(
