      ...
      ? Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                // Navigate to your ProjectEditorScreen, passing the existing RW id
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => ProjectEditorScreen(
                      ...
                      isAdmin: true,
                      // you might extend ProjectEditorScreen to accept an rwId
                      // and pre-load that RW document for editing
                      rwId: doc.id,
                    ),
                  ),
                );
              ...
              onPressed: () async {
                final ok = await showDialog<bool>(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    content: Text('Na pewno usunąć ten dokument ${d['type']}?'),
                    actions: [
