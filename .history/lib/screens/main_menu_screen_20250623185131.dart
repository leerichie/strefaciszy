      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            // Replace your old trailing with this:
            trailing: SizedBox(
              width: 90,
              height: 90,
              // FittedBox will scale its child down to exactly fit the 80×80 box:
              child: FittedBox(
                fit: BoxFit.contain,
                child: QrImageView(
                  data: 'https://strefa-ciszy.web.app/app-release.apk',
                  version: QrVersions.auto,
                  // you can still set `size:` to 80, but FittedBox will handle it:
                  size: 90,
                ),
              ),
            ),
