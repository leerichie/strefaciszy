                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                // 1) Grab the saved items and start a batch
                                final items =
                                ...
                                // 3) Delete the RW document itself
                                final docRef = doc.reference;
                                batch.delete(docRef);

                                // 4) ***NEW***: clear the project’s own items & reset its status
                                ...
                                // 5) Commit and show feedback
                                await batch.commit();
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Przywrócono stan i wyczyszczono projekt & RW',
                                    ),
                                  ),
                                );
                              },
