...
Future<void> main() async {
  ...
  await FirebaseAppCheck.instance.activate(
    /// Android: Play Integrity (you already did this)
    androidProvider: AndroidProvider.playIntegrity,

    /// iOS: now using App Attest
    appleProvider: AppleProvider.appAttest,

    /// Web: reCAPTCHA v3 (you already registered)
    webRecaptchaSiteKey: '6LeBX2QrAAAAAKfgNEf1JLC7QO6fXdrLSbl2GsB3',
  );
