...
/// Callback signature for adding a note
typedef OnNoteAdded = Future<Note?> Function(BuildContext context);

/// A horizontally scrolling list of note snippets, with an “add note” button
class NotesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 88, // match your PhotoGallery height
      child: Row(
        children: [
          // “Add note” button
          GestureDetector(
            onTap: () async {
              ...
              // parent will insert into Firestore + local list
            },
            child: Container(
              width: 64,
          ...
          // Horizontal list of note previews
          Expanded(
