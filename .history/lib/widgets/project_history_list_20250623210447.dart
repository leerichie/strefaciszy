...
import 'package:strefa_ciszy/screens/audit_log_screen.dart'; // for _iconForAction()

/// A reusable widget that shows the audit‐log entries for a single project.
class ProjectHistoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Query only entries tagged with this project
      ...
      builder: (ctx, snap) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (ctx, i) {
            ...
            // pull out the first „Szczegóły” bullet, if any:
            String detailsLine = '';
            final details =
